...
export default function AilmentField ({
  ver,
  loc,
  file,
  newcompare,
  ...
  const rawData = Object.values(ailment_field)
  ...
  useEffect(() => {
    ...
    const searchit = makeUnique.filter((ailment) =>
      (`${
        ailment.data_id} - ${
        ailment.require_id == 1 ? ailmentnames[ailment.require_value] && ailmentnames[ailment.require_value].name: ""} ${
        ailment.require_id == 3 ? ailmentnames[ailment.require_value_2] && ailmentnames[ailment.require_value_2].name: ""} ${
        ailment.require_id == 6 ? passivenames[ailment.require_value] && passivenames[ailment.require_value].name: ""} ${
        ailment.require_id == 9 ? equipmentpassivenames[ailment.require_value] && equipmentpassivenames[ailment.require_value].name: ""} ${
        ailment.require_id == 1 || ailment.require_id == 2 ? ailmentnames[ailment.require_value] && ailmentnames[ailment.require_value].jpname: ""}- #${ailment.require_value}`).toLowerCase().includes(searchTerm)
    );
    const getailmentfilter = searchit.filter(function (ef) {
      const newfilterpull = ef.effect_id && ef.effect_id.ailment_effect === condFilter;
      if (condFilter !== "") {
  ...
  return (<div>
    ...
    <div className="event-search-reverse-holder">
      {showFilter == true ? "" :
        <ul className="bufftypes">
          <Link to={`/${ver}/ailments/ailment_field/compare`} >
      ...
      {showFilter == true ? "" :
        <ul className="bufftypes">
          <Link to={`/${ver}/ailments/ailment_field/new`} >
    ...
    <div className="filterholder noselect" id={showFilter ? "showfilteren" : "hiddenfilteren"}>
      ...
      <div className="filterholderflair">
        <ul className="bufftypes">
          <Link to={`/${ver}/ailments/ailment_field/compare?filter=true`} >
            <Tippy content={`Added from update`}>
              <li className={`${newcompare == "compare" ? "filteractive" : "filterinactive"} buffbutton newbutton`}></li>
            </Tippy>
          </Link>
          <Link to={`/${ver}/ailments/ailment_field/new?filter=true`} >
            <Tippy content={`Full list`}>
              <li className={`${newcompare == "new" ? "filteractive" : "filterinactive"} buffbutton fullbutton`}></li>
            </Tippy>
          </Link>
