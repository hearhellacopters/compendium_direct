                ...
                <div>
                    ...
                    {hide_type != true ?
                        ...
                        <div className="typeval">
                                {addformatting(effect_id.stack_flag,"bu")}
                            </div>
                        :""}
                        ...
                        effect_id && effect_id.effect_value_typestr == undefined ? "" :
                            <div className="typeval">
                                {addformatting(effect_id.effect_value_typestr,"bu")}
                            </div>
                        }
                ...
                <div>
                    ...
                    effect_id == undefined ? "":
                        ...
                        <div className="padleft updatelink clicky" onClick={() => seteffect(effect_id.rank9)}>
                            ...
                            {effect_id && effect_id.rank9.value5 && effect_id.rank9.value5 != undefined ? " "+effect_id.rank9.value5 : ""}
                        </div>}
