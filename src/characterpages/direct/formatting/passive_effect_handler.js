    ...
    var effect_str = ""
       ...
       if(value_trans == "command_id_2_chance"){
        ...
        if(value_trans == "split_by_3"){
            var value1_1 = val_edit_type(2, effect_value1)
            if(value1_1 == 0){
                effect_str = effect_str
            .replace(/Adds \[target\] ATK Up.*\n/gm, "")
            }
            var value1_2 = val_edit_type(3, effect_value1)
            if(value1_2 == 0){
                effect_str = effect_str
            .replace(/Adds \[target\] DEF Up.*\n/gm, "")
            }
            var value1_3 = val_edit_type(4, effect_value1)
            if(value1_3 == 0){
                effect_str = effect_str
            .replace(/Adds \[target\] SPD Up.*\n/gm, "")
            }
            var value2_2 = val_edit_type(3, effect_value2)
            if(value2_2 == 0){
                effect_str = effect_str
            .replace(/Adds \[target\] INT BRV Up.*\n/gm, "")
            }
            var value2_3 = val_edit_type(4, effect_value2)
            if(value2_3 == 0){
                effect_str = effect_str
        ...
        if(value_trans == "ailment_id_1s"){
            ...
            if(ailment_pull != undefined){
                effect_value1 = `[${AilmentNames[effect_value1].name}] #${effect_value1}`
             }
            if(effect_value1 == -1){
            effect_value1 = "any"
            }
        ...
        if(value_trans == "ailment_id_2"){
            if(AilmentNames[effect_value2] != undefined){
                effect_value2 = `[${AilmentNames[effect_value2].name}] #${effect_value2}`
             } else {
...
export default passive_effect_handler