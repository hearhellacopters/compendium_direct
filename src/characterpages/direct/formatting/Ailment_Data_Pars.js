...
const ailment_data_pars = (
    ...
    if (value_trans == "neg_infinite") {
        var neg1 = tables.rank1.value1 == -1 ? "∞" : tables.rank1.value1
        var neg2 = tables.rank2.value1 == -1 ? "∞" : tables.rank2.value1
        var neg3 = tables.rank3.value1 == -1 ? "∞" : tables.rank3.value1
        var neg4 = tables.rank4.value1 == -1 ? "∞" : tables.rank4.value1
        var neg5 = tables.rank5.value1 == -1 ? "∞" : tables.rank5.value1
        var neg6 = tables.rank6.value1 == -1 ? "∞" : tables.rank6.value1
        var neg7 = tables.rank7.value1 == -1 ? "∞" : tables.rank7.value1
        var neg8 = tables.rank8.value1 == -1 ? "∞" : tables.rank8.value1
        var neg9 = tables.rank9.value1 == -1 ? "∞" : tables.rank9.value1
        var neg10 = tables.rank10.value1 == -1 ? "∞" : tables.rank10.value1
        tables = {
            rank1: {
                value1: neg1
            },
