...
import PassiveLinkParmFormatting from '../components/Passives/PassiveLinkParmFormatting.js';
...
function CharacterForcePassives ({
  linkeddata,
  ver,
  newcompare,
  loc,
  ...
  const banerDisplayTerm = "force empowerment";
...
export default trackWindowScroll(CharacterForcePassives)