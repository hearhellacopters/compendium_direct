...
import DirectEventImages from './DirectEventImages';
import DirectEventCharFace from './DirectEventCharFace';
...
export default function CharacterEventPage ({
  data,
  ver,
  master_index
}) {
