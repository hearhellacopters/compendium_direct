...
const ReminderMaker = ({eventdata}) =>{
    ...
    var makeGoogleCalendarUrl = function () { return makeUrl("https://calendar.google.com/calendar/render", {
        action: "TEMPLATE",
    ...
    var makeOutlookCalendarUrl = function () { return makeUrl("https://outlook.live.com/owa", {
        rru: "addevent",
    ...
    var makeYahooCalendarUrl = function () { return makeUrl("https://calendar.yahoo.com", {
        v: 60,
        view: "d",
        type: 20,
        title: event.name,
