...
const EnemyAbilities_MasterListDirectDetails = ({
    ai,
    enemy_id,
    stats
}) =>{
    ...
    return(
        enemyabilities != undefined && fullcommands != undefined && fullcommands[0] != undefined ?
            <EnemyAbilityHandoffDirect match={fullcommands} enemy_id={enemy_id}/>
        :
        "Loading..."
    )
    }
}
export default EnemyAbilities_MasterListDirectDetails