...
const EnemyFormattingDirect = ({ match, stats, alllevels, setlevel, battle_enemy_id, ProcessedEnemies, ProcessedEvents, ProcessedLevels, levelurl, battle_enemy, PartnerCharacters, ProcessedCharacters }) => {
    ...
    },[ran,setran,PartnerCharacters,set_helpers,set_chars,sethelpers,setset_helpers,battle_enemy,setcolumns,setForcetimeTabsearch,ForcetimeTabsearch])
            ...
            <div className="content">
                ...
                <div className={`enemyholderdesc elements2 ${spancheck == false ? "" :"nomargenemy"}`}>
                    ...
                    <div className="enemyholderdesc2 normalfont">
                            ...
                            {enemy.desc == undefined ? "" : addformatting(enemy.desc)}
                            </div>
                            :
                            ""
                            }
