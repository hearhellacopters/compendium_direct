...
function CharacterAbility ({
  ...
  const rawData = Object.values(character_ability)
  ...
  }, [searchTerm, clearFilter, condFilter, condFilter2, AdvanceValuesearch, AdvanceValuesearch2, AdvanceValuesearch3, AdvanceValuesearch4, reverse]);
...
export default trackWindowScroll(CharacterAbility)