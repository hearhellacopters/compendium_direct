...
const Call_character_ability_gl_new = () => {
    ...
    useEffect(() => {
        let mounted = true
        if (mounted && character_ability_new_gl == undefined) {
            dispatch(getGLCharacterAbilityNew());
        }
        return function cleanup() {
            mounted = false
        }
    }, [dispatch, character_ability_new_gl])
    ...
    return (
        master_index != undefined &&
            ...
            <Categories
                ...
                character_ability={character_ability_new_gl}
...
//file name change
export default Call_character_ability_gl_new