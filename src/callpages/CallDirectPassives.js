...
import PassivesDirect from '../PassivesDirect';

const CallPassivesDirect = () =>{
    ...
    const jp_gamelist_passive = useSelector((state) => state.jp_gamelist_passive.jp_gamelist_passive)

    const gl_gamelist_passive = useSelector((state) => state.gl_gamelist_passive.gl_gamelist_passive)
...
export default CallPassivesDirect;