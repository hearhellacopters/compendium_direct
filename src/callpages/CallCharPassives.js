...
import CallCharPassivesHandoff from './CallCharPassivesHandOff';
import Loading from './_loading'

const CallCharPassives = () =>{
    ...
    useEffect(() => {
      ...
      if(filtered != undefined ){
        return (
            <CallCharPassivesHandoff match={match} filtered={filtered}/>
        )
      } else {
          return(
            <Loading/>
...
export default CallCharPassives;