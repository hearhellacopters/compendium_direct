...
const CallAbilitiesDirect = () =>{
    ...
    const jp_gamelist_ability = useSelector((state) => state.jp_gamelist_ability.jp_gamelist_ability)

    const gl_gamelist_ability = useSelector((state) => state.gl_gamelist_ability.gl_gamelist_ability)
