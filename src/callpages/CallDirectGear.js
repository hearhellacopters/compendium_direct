...
const CallGearDirect = () =>{
    ...
    const jp_gamelist_gear = useSelector((state) => state.jp_gamelist_gear.jp_gamelist_gear)

    const gl_gamelist_gear = useSelector((state) => state.gl_gamelist_gear.gl_gamelist_gear)
