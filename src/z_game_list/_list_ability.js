...
const GameListAbility = ({
    ...
    }, [setCondFilter, ProcessedAbilities, Typesearch, setTypesearch, master_index])
    ...
    }, [rawData, merge, limits, condFilter, reverse, searchTerm, BRVHPUpgrade, Slower,Faster, AA, BRV, BT, Delay3, Self_Harm, Break, Buff_Extension, Increase2, BreakCancel, Battery, Call75, CallLD, Cleanse, Turn_Manipulator, Counter, Dark, Delay, Delete, Dispel, EX, Earth, FR, Fire, FollowUp, Free, Group, HP, Heals, Holy, Ice, IgnoreDEF, Increase, Instant, KnockBack, LD, Magic, Melee, Ranged, Revive, S1, S2, Thunder, Trap, Water, Wind])
    ...
    }, [rawData, merge, limits, condFilter, reverse, searchTerm, Slower, BRVHPUpgrade, Faster, AA, BRV, BT, Self_Harm, Break, Buff_Extension, Delay3, Battery, BreakCancel, Turn_Manipulator, Increase2, Call75, CallLD, Cleanse, Counter, Dark, Delay, Delete, Dispel, EX, Earth, FR, Fire, FollowUp, Free, Group, HP, Heals, Holy, Ice, IgnoreDEF, Increase, Instant, KnockBack, LD, Magic, Melee, Ranged, Revive, S1, S2, Thunder, Trap, Water, Wind])
    ...
    return (
        <>
            ...
            <ul className="bannertabs">
                <Link to={`/${ver}/gamelist/ailments`}>
                    <li className={""} >Buffs</li>
                </Link>
                <Link to={`/${ver}/gamelist/abilities`}>
                    <li className={"active"} ><span className="gemselected" />Abilities</li>
                </Link>
                <Link to={`/${ver}/gamelist/gear`}>
                    <li className={""} >Gear</li>
                </Link>
                <Link to={`/${ver}/gamelist/passives`}>
                    <li className={""} >Passives</li>
                </Link>
                <Link to={`/${ver}/gamelist/spheres`}>
...
export default trackWindowScroll(GameListAbility)