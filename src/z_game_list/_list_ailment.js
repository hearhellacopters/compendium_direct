...
const GameListAilment = ({
    ...
    }, [setCondFilter, ProcessedBuffs, Typesearch, setTypesearch, master_index])
        ...
        <>
            ...
            <div className="filterholder noselect" id={showFilter ? "showfilteren" : "hiddenfilteren"}>
                ...
                <div className="filterholderflair">
                    ...
                    <div className="margeholder">
                        <div className="Merge">
                            <label htmlFor='search2' className="MergeText">Merge Filters?</label>
...
export default trackWindowScroll(GameListAilment)