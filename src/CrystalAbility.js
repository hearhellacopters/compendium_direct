      ...
      <div><h1 className="">Crystal Brilliance</h1>
          <div className="filterholder" id={showFilter ? "showfilteren" : "hiddenfilteren"}>
            ...
            <div>
              ...
              <div className="yellowcolor">Passives and stats are automatically applied to color matching characters.</div><br/>
              <div className="yellowcolor">Everytime you master a whole crystal color, you will unlock a Crystal Ability to use in battle by spending <span className="crypoints"></span> Crystal Power points.</div><br/>
              <div className="yellowcolor">You get <span className="crypoints"></span> x10 Crystal Power points on the first mastery, <span className="crypoints"></span> x5 on the 2nd to 5th and then <span className="crypoints"></span> x10 on the last. Totalling 40 pts. </div><br/>
              <div className="yellowcolor">Points spent on an ability do not regenerate as the battle goes on battle.</div>
            </div>
