...
import EnemyAbilities_MasterListDirectDetails from './EnemyAbilities_MasterListDetails';

export default function EnemyAbilities_MasterListDirectDetailsHandler({
    alllevels,
    ai,
    enemy_id,
    Level
