...
import AilmentDataFormattingEnemy from './Buff_Handler/AilmentDataFormattingEnemy';
import ReplacerCharacter from '../ReplacerCharacter'
import EnemyForceGauge from './EnemyForceGauge';
import { getLevels } from '../../redux/ducks/levels';
import EnemyDetailsLevelHandler from './EnemyDetailsLevelHandler';
import EnemyAbilities_MasterListDirectDetailsHandler from './Ability_Handler/EnemyAbilities_MasterListDetailsHandler';
                ...
                <div className="blockresists2">
                    {match.AilmentResistsLow != undefined ?
                        <div className="resisttypeholder">
                            ...
                            <div className="resistlow">{ReplacerEnemyDesc(match.AilmentResistsLow)}</div>
                        </div>
                        : ""}
                    {match.AilmentResistsHigh != undefined ?
                        <div className="resisttypeholder">
                            ...
                            <div className="resisthigh">{ReplacerEnemyDesc(match.AilmentResistsHigh)}</div>
                        </div>
                        : ""}
                    {match.AilmentResistsImmune != undefined ?
                        <div className="resisttypeholder">
                            ...
                            <div className="resistimmune">{ReplacerEnemyDesc(match.AilmentResistsImmune)}</div>
                        </div>
                        : ""}
                </div>
                : ""}
            ...
            {activeDesc == true ?
                <div className='bluebase infobase makeright largefont'>
                    {getDesc == undefined ?
                        "Loading..."
                        :
                        getDesc && ReplacerEnemyDesc(getDesc)}
                </div>
                : ""}
            {activeCast != true ? "" :
                <div className="">
                        ...
                        <div className="orbcondtext">
                            {getForce.ForceTime.map((self,i) => (
                                <div key={i} className="orbconbholder forcebholder">
                                    <div><span className="unique">{self.name}</span><br />{ReplacerEnemyDesc(self.desc)}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                            ...
                            <div className="infoholder egfbanner">
                                <div className={`infonameholderenemybuff centeralign ${self.name == "Force Weakness" ? "blackbanner" : self.name == "Force Gauge Increase" ? "Buffbanner" : "Debuffbanner"}`}>
                                    <span className="unique">
                                        {self.name && ReplacerCharacter(self.name)}
                                    </span>
